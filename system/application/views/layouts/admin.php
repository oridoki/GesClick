...
<body>
	<div id="cont">
		<div class='header rounded'>
			...
			<div class='logout'>
				<?= anchor("config/index", _("Configuración")) ?>
				&nbsp; | &nbsp;
				<?= anchor("auth/logout", _("Logout")) ?>
			</div>
			<div class='navigation'>
				<ul>
					<li><?= anchor("customer", _("CLIENTES")) ?></li>
					<li><?= anchor("bills", _("FACTURACIÓN")) ?></li>
					<li><?= anchor("task", _("CONTROL DE TAREAS")) ?></li>
				</ul>
			</div>
		</div>
